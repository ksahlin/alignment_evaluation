...
def plot_accuracy(input_csv, outfolder, tools, palette):
...
def plot_percentage_aligned(input_csv, outfolder, tools, palette):
    matplotlib.rcParams.update({'font.size': 18})
    sns.set(font_scale=1.9)
    sns.set_style("whitegrid")
...
def plot_overaligned(input_csv, outfolder, tools, palette):
    matplotlib.rcParams.update({'font.size': 18})
    sns.set(font_scale=1.9)
    sns.set_style("whitegrid")
...
def plot_memory_usage(input_csv, outfolder, tools, palette):
    matplotlib.rcParams.update({'font.size': 18})
    sns.set(font_scale=1.9)
...
def main(args):
    ...
    plot_memory_usage(runtime_mem_csv, args.outfolder, tools, palette)
