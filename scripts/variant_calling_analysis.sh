...
grep -E "\t[ACGT]\t[ACGT]\t" $refs/$chr_id.vcf  >> $refs/$chr_id.variants.SNV.vcf
grep -v -E "\t[ACGT]\t[ACGT]\t" $refs/$chr_id.vcf  > $refs/$chr_id.variants.INDEL.vcf
...
do 
    ...
    do
        ...
        do
            ...
            touch $outroot/$chr_id/$read_length.$tool.variants.SNV.vcf
            grep "#"  $outroot/$chr_id/$read_length.$tool.variants.vcf > $outroot/$chr_id/$read_length.$tool.variants.SNV.vcf
            grep -E "\t[ACGT]\t[ACGT]\t" $outroot/$chr_id/$read_length.$tool.variants.vcf >> $outroot/$chr_id/$read_length.$tool.variants.SNV.vcf
            grep -v -E "\t[ACGT]\t[ACGT]\t" $outroot/$chr_id/$read_length.$tool.variants.vcf > $outroot/$chr_id/$read_length.$tool.variants.INDEL.vcf
