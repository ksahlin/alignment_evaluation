...
# for read_lengh in 100 150 #100 #150 #200 250 300 
# do 
...
#             mason_simulator -ir $refs/$chr_id.fa -n 200000 --illumina-read-length $read_lengh --fragment-mean-size 3000 -o $outroot/$chr_id/$read_lengh.L.fq -or $outroot/$chr_id/$read_lengh.R.fq -oa $outroot/$chr_id/$read_lengh.sam
#         fi
